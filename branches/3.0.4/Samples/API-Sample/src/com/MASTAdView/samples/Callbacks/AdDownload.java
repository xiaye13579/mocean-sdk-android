...
public class AdDownload extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setAdLayoutParams();
        adserverView.getAdDelegate().setAdDownloadHandler(new UserAdDownload());
	...
	String uMessage;
    class UserAdDownload implements MASTAdDelegate.AdDownloadEventHandler {
		...
		public void onDownloadBegin(MASTAdView arg0) {
			...
			updateUi(mUpdateResults, "Begin Downloading");
		}

		@Override
		public void onDownloadEnd(MASTAdView arg0) {
			Log.d("Callback", "end");
			updateUi(mUpdateResults, "End Downloading");
		}
